...
| シナリオ<img width="160" height="1" /> | ワークフローのスクリーンショット | 出力結果 |
| :-- | :--: | :--: |
| **基本**<br/>テキストを入力（追加）し、画像を生成（変換）、さらに1枚に融合（結合）。 | <img src="https://file.tongflow.com/public/demos/basic.png" width="420" alt="ワークフロー" /> | <img src="https://file.tongflow.com/public/demos/basic_result.png" width="240" alt="結果" /> |
| **中級**<br/>（テーマ追加 → 台本生成 → 音声生成） + （人物の説明 → 画像生成） → リップシンク動画を生成 = デジタルヒューマンのナレーション。 | <img src="https://file.tongflow.com/public/demos/digitalhuman.png" width="420" alt="ワークフロー" /> | <video src="https://github.com/user-attachments/assets/a803394d-0ccf-4023-9b06-5c1581345758" width="240"></video>|
| **上級**<br/>歌詞生成 + 楽曲生成 + 人物生成 + シーン生成 + 絵コンテ生成 → MV生成 | <img src="https://file.tongflow.com/public/demos/mv.png" width="420" alt="ワークフロー" /> | <video src="https://github.com/user-attachments/assets/2bc71e3c-3ed6-48b2-81e7-82ad5976d801" width="240"></video> |
